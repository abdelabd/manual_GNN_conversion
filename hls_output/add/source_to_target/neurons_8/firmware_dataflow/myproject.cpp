...
void myproject(
    ...
    nnet::aggregate<input2_t, input3_t, layer5_t, aggregation_config5>(layer4_out_1, edge_index, layer5_out); // aggr5
    ...
    nnet::edgeblock<input2_t, input3_t, layer7_t, config7>(layer6_out, layer4_out_2, edge_index, layer8_out, R2_w0, R2_b0, R2_w1, R2_b1, R2_w2, R2_b2, R2_w3, R2_b3); // R2

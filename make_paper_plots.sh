...
python extract_scan_data.py --dir numbers_for_paper/n448xe896_dataflow_rf1_reports
python extract_scan_data.py --dir numbers_for_paper/n448xe896_dataflow_rf8_reports
...
python plot_scans.py --reuse 1 --precision 'ap_fixed<14,7>' --dir numbers_for_paper/n448xe896_dataflow_rf1_reports --max-nodes 448 --max-edges 896 --paradigm dataflow
python plot_scans.py --reuse 8 --precision 'ap_fixed<14,7>' --dir numbers_for_paper/n448xe896_dataflow_rf8_reports --max-nodes 448 --max-edges 896 --paradigm dataflow
